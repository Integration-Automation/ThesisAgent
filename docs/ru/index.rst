...
Все 13 MCP-инструментов: :doc:`/mcp`.
...
Рабочий пример: ``scripts/regen_fang2026.py`` содержит обогащённую
сводку, написанную вручную именно таким образом (одна статья,
rich-tier, zh-tw). Пакет из нескольких статей повторяет ту же форму,
по одной записи на статью в кортеже ``PaperCollection``.
...
* 13 инструментов MCP-сервера: :doc:`/mcp`
