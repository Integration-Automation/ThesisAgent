...
read from ``THESISAGENTS_SPRINGER_API_KEY``. The plugin loads but the
...
_API_KEY_ENV = "THESISAGENTS_SPRINGER_API_KEY"  # noqa: S105  # nosec B105  # env var name, not a secret value
