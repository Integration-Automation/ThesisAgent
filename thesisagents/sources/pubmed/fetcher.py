...
Rate limit: NCBI caps anonymous traffic at 3 req/s. An ``THESISAGENTS_NCBI_API_KEY``
...
_API_KEY_ENV = "THESISAGENTS_NCBI_API_KEY"
_TOOL_NAME = "thesisagents"
...
def _contact_email() -> str:
    return os.environ.get("THESISAGENTS_CONTACT_EMAIL", "thesisagents@example.invalid")
