...
* **Official API** — when ``THESISAGENTS_IEEE_API_KEY`` is set, the plugin
...
_OPT_OUT_ENV = "THESISAGENTS_DISABLE_IEEE_SCRAPING"
_API_KEY_ENV = "THESISAGENTS_IEEE_API_KEY"
...
class IeeeFetcher(Fetcher):
    ...
    def __init__(self) -> None:
        ...
        # IEEE is default-on; flip off via THESISAGENTS_DISABLE_IEEE_SCRAPING=1.
        # Subscribers should set THESISAGENTS_IEEE_API_KEY for the official
