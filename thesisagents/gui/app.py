"""GUI entry point. ``thesisagents-gui`` and ``thesisagents gui``
both resolve here.
"""
...
from thesisagents.gui.pages.settings import apply_saved_env, saved_ui_language

if TYPE_CHECKING:
    from PySide6.QtGui import QFont, QIcon


# Repo root → assets/icon.ico. parents[2] = thesisagents/gui/app.py
# → thesisagents/gui → thesisagents → repo. Resolved lazily so the
...
def main(argv: list[str] | None = None) -> int:
    ...
    from thesisagents.gui.i18n import normalise_language
