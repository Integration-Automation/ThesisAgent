...
Separate from ``thesisagents/exporters/i18n.py`` so the slide-deck
...
_LABELS: Final[dict[str, dict[str, str]]] = {
    ...
    "deck.format_ris": {
        "en": "RIS", "zh-tw": "RIS", "zh-cn": "RIS", "ja": "RIS",
        "es": "RIS", "fr": "RIS", "de": "RIS", "ko": "RIS",
        "pt": "RIS", "ru": "RIS", "it": "RIS", "vi": "RIS",
        "hi": "RIS", "id": "RIS",
    },
    "deck.format_csv": {
        "en": "CSV", "zh-tw": "CSV", "zh-cn": "CSV", "ja": "CSV",
        "es": "CSV", "fr": "CSV", "de": "CSV", "ko": "CSV",
        "pt": "CSV", "ru": "CSV", "it": "CSV", "vi": "CSV",
        "hi": "CSV", "id": "CSV",
    },
    "deck.format_csl": {
        "en": "CSL-JSON", "zh-tw": "CSL-JSON", "zh-cn": "CSL-JSON", "ja": "CSL-JSON",
        "es": "CSL-JSON", "fr": "CSL-JSON", "de": "CSL-JSON", "ko": "CSL-JSON",
        "pt": "CSL-JSON", "ru": "CSL-JSON", "it": "CSL-JSON", "vi": "CSL-JSON",
        "hi": "CSL-JSON", "id": "CSL-JSON",
    },
    "deck.options_group": {
        "en": "Options",
        "zh-tw": "選項",
    ...
    "deck.light_mode_label": {
        "en": "Light mode (white background, dark mode is default)",
        "zh-tw": "亮色模式(白色背景,預設為暗色)",
        "zh-cn": "亮色模式(白色背景,默认为暗色)",
        "ja": "ライトモード(白背景,既定はダーク)",
        "es": "Modo claro (fondo blanco; oscuro por defecto)",
        "fr": "Mode clair (fond blanc ; sombre par défaut)",
        "de": "Heller Modus (weißer Hintergrund; dunkel ist Standard)",
        "ko": "라이트 모드 (흰 배경, 기본은 다크)",
        "pt": "Modo claro (fundo branco; escuro por padrão)",
        "ru": "Светлый режим (белый фон; по умолчанию тёмный)",
        "it": "Modalità chiara (sfondo bianco; scuro per default)",
        "vi": "Chế độ sáng (nền trắng; mặc định là tối)",
        "hi": "Light mode (सफ़ेद पृष्ठभूमि; डिफ़ॉल्ट dark है)",
        "id": "Mode terang (latar putih; default gelap)",
    },
    "deck.export_button": {
        "en": "Export",
        "zh-tw": "輸出",
