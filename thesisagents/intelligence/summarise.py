...
Optional: ``THESISAGENTS_LLM_MODEL`` overrides ``DEFAULT_MODEL``.
"""
...
from thesisagents.exporters.i18n import normalise_language
...
_MODEL_ENV: str = "THESISAGENTS_LLM_MODEL"
