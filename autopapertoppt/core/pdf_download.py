...
``AUTOPAPERTOPPT_PDF_COOKIES_FILE`` points at a Netscape ``cookies.txt``
...
from autopapertoppt.core.models import Paper, PaperCollection
from autopapertoppt.core.pdf_cookies import cookies_for_url
